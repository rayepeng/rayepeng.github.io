// Migrated from antfu.me/data/talks.ts
// Type aligned with src/content/config.ts talksCollection schema
...
// Sort presentations within each talk by date descending
talks.forEach((talk) => {
...
// Sort talks by their most recent presentation date
talks.sort((a, b) =>
  new Date(b.presentations[0].date).getTime() - new Date(a.presentations[0].date).getTime(),
)
